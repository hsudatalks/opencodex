...
fill-first use their own policies. Existing Codex threads retain affinity during a turn. After turn
settlement, a binding more than 1000 urgency points behind the highest bucket is released, allowing
freshly reset accounts to rotate in once without reacting to ordinary urgency drift. Failover,
account exclusion, affinity expiry, or 401/403 and 429 recovery can also rebind it. Give the accounts a
