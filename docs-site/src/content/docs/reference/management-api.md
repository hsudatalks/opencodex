...
| `PUT, PATCH /api/codex-auth/pool-strategy` | Update Codex account-pool strategy, sticky limit, or per-account active-turn capacity | 400 invalid strategy/config |
