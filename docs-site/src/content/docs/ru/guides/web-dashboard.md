...
| **Sub-agent delegation** | Выбор нативной/маршрутизируемой модели и необязательного уровня рассуждений, общих для руководства Univers Gateway по делегированию и опциональных нативных значений подагентов Codex по умолчанию. Это не маршрутизатор отдельных порождений; см. ниже. |
...
`injectionEffort`. Выбранные значения используются в добавляемом Univers Gateway руководстве по
...
когда активной маршрутизацией Codex управляет Univers Gateway. Внешняя пользовательская конфигурация
...
:::caution
Эти два переключателя независимы. Отключение руководства Univers Gateway по делегированию не отключает
