...
import { reconcileApiKeyBalancerProviders } from "../providers/api-key-balancer";
...
export const STATE_STORE_REGISTRATIONS = [
  ...
  {
    name: "api-key-balancer",
    reconcileGeneration: context => reconcileApiKeyBalancerProviders(context.providerNames),
  },
  {
