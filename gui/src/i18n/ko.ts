...
export const ko: Record<TKey, string> = {
  ...
  "common.retry": "재시도",
  "auth.adminTokenTitle": "Univers Gateway 관리자 토큰 (OPENCODEX_ADMIN_AUTH_TOKEN)",
  ...
  "startup.subtitle": "재부팅 후 로컬 프록시 라우팅이 재연결 반복으로 이어지기 전에 Codex가 Univers Gateway에 연결될 수 있는지 확인합니다.",
  ...
  "startup.summary.protected": "재부팅 후에도 Univers Gateway가 자동으로 준비됩니다",
  ...
  "startup.riskDetailCustomLocal": "Codex가 사용자 지정 로컬 게이트웨이를 바라봅니다. Univers Gateway는 해당 게이트웨이의 재시작 수명주기를 관리하거나 검증할 수 없습니다.",
  ...
  "startup.codexRuntime.clampHidden": "Univers Gateway가 Codex {version}을(를) 사용해 일부 reasoning effort 옵션이 숨겨졌습니다.",
  "startup.codexRuntime.clampHiddenWithEfforts": "Univers Gateway가 Codex {version}을(를) 사용해 일부 reasoning effort 옵션이 숨겨졌습니다(제거됨: {efforts}).",
  "startup.codexRuntime.olderBinary": "Univers Gateway가 더 오래된 Codex 바이너리({version})를 사용 중입니다. 더 새 설치를 사용할 수 있습니다.",

  // dashboard
  "dash.subtitle": "로컬 Univers Gateway 프록시와 프로바이더, 그리고 Codex로 라우팅되는 모델의 실시간 상태입니다.",
  ...
  "dash.stopping": "중지 중…",
  "dash.codexAutoStart": "Codex 실행 시 Univers Gateway 시작",
  ...
  "dash.shadowCallTooltip": "Codex 앱은 스레드 제목 자동 생성, 커밋 메시지 생성, 스킬 오케스트레이션 같은 내부 작업을 백그라운드로 호출합니다. 이때 쓰는 모델은 클라이언트 버전마다 달라서 Univers Gateway는 {models}를 모두 가로챕니다. 이 설정을 켜면 해당 호출이 선택한 모델로 넘어갑니다.",
  ...
  "dash.maintenanceHint": "Codex 모델 카탈로그를 새로고침하거나 최신 Univers Gateway 릴리스를 설치합니다.",
  ...
  "dash.projectConfigTitle": "프로젝트 Codex 설정이 Univers Gateway를 우회합니다",
  "dash.projectConfigHint": "저장소 로컬 설정이 Univers Gateway 프록시를 덮어씁니다(예: OpenCode Go로 직접 라우팅). 해당 프로젝트에서 ~/.codex/config.toml 프록시를 쓰려면 제거하세요.",
  "dash.checkUpdate": "업데이트 확인",
  "dash.updateTitle": "Univers Gateway 업데이트",
  ...
  "dash.updateStatus.running": "Univers Gateway 업데이트 중입니다.",
  ...
  // providers
  "prov.subtitle": "Univers Gateway가 Codex로 라우팅하는 업스트림 프로바이더를 설정합니다. 계정으로 로그인하거나, 프로바이더를 추가하거나, 원본 설정을 편집하세요.",
  "prov.add": "프로바이더 추가",
  ...
  "oauthTos.anthropicBody": "Claude 구독 OAuth 토큰을 Univers Gateway 같은 타사 프록시에서 직접 재사용하는 방식은 Anthropic이 지원하는 통합이 아니며 접근이 제한될 수 있습니다. Claude 구독을 사용하는 공식 Agent SDK 통합은 별도입니다.",
  "oauthTos.highBody": "Univers Gateway는 {provider}를 타사 OAuth 경로로 연결합니다. 지원되지 않는 사용 방식이면 접근이 제한되거나 정지될 수 있습니다.",
  "oauthTos.elevatedBody": "Univers Gateway는 {provider}를 비공식 OAuth 경로로 연결합니다. 가능하면 공식 클라이언트를 사용하세요. 비정상적이거나 자동화된 트래픽은 남용으로 간주되어 접근이 제한되거나 정지될 수 있습니다.",
  "oauthTos.saferPath": "더 안전한 방법: Univers Gateway에 API 키를 대신 설정하세요.",
  ...
  "models.subtitle": "Codex가 보는 모델을 켜고 끕니다 — 네이티브 GPT passthrough와 라우팅된 모델을 프로바이더별로 묶어 보여줍니다(헤더를 클릭하면 접힘). 숨긴 모델은 카탈로그와 선택기에서 빠지지만 정확한 id로 직접 호출할 수 있습니다. 변경 사항은 다음 Codex 턴에 적용됩니다 — Univers Gateway가 Codex의 5분 모델 캐시를 무효화하므로 재시작이 필요 없습니다.",
  ...
  // subagents
  "sub.subtitle": "Codex의 {cmd} 는 우선순위 상위 5개 모델만 오버라이드로 노출합니다. 여기서 최대 5개를 선택하면 — 네이티브 gpt 또는 라우팅된 모델 — Univers Gateway가 카탈로그 우선순위를 설정해 정확히 이들이 앞에 옵니다. 다른 모델도 정확한 이름으로 호출할 수 있으며, 이 설정은 표시 항목만 제어합니다.",
  "sub.featured": "추천",
  ...
  "logs.tabLogs": "로그",
  "logs.tabDebug": "디버그",
  "logs.subtitle": "로컬 Univers Gateway 프록시를 거친 최근 요청입니다. 최신순.",
  ...
  "usage.range.30d": "월",
  "usage.range.7d": "주",
  "usage.window.older": "이전 기간",
  "usage.window.newer": "다음 기간",
  ...
  "usage.filter.key.label": "접근 키",
  "usage.filter.key.all": "모든 키",
  "usage.filter.key.clear": "키 필터 지우기",
  "usage.key.none": "키 없음",
  "usage.keys.rangeLimited": "키별 내역은 일/주 기간만 지원합니다. 월/전체 기간은 키 차원 없이 집계됩니다.",
  "usage.col.requests": "요청",
  "usage.col.measured": "측정됨",
  "usage.col.reported": "측정됨",
  "usage.col.tokens": "토큰",
  "usage.col.key": "키",
  "usage.col.cost": "예상 비용",
  "usage.col.unpriced": "가격 미정",
  "usage.col.share": "비율",
  ...
  "nav.openMenu": "메뉴 열기",
  "nav.closeMenu": "메뉴 닫기",
  "integrations.subtitle": "클라이언트를 Univers Gateway에 연결하고 자격 증명과 설정 복원을 관리합니다.",
  ...
  "integrations.codex.body": "Codex 연결은 프록시 서비스가 관리합니다. Univers Gateway를 시작하면 적용되고 서비스를 중지하면 기본 라우팅으로 복원됩니다.",
  ...
  "integrations.dialog.desktop.changes": "{path}에 Univers Gateway 게이트웨이 프로필이 있으면 먼저 자격 증명 없는 표준 프로필을 선택한 뒤 이전 프로필과 백업을 제거합니다.",
  "integrations.dialog.desktop.breakage": "Claude Desktop은 Univers Gateway를 통한 모델 대신 표준 Claude로 돌아갑니다.",
  "integrations.dialog.desktop.undo": "다시 켜면 저장된 모델 할당으로 Univers Gateway 프로필을 새로 만듭니다.",
  ...
  "integrations.native.error.desktopCleanupIncomplete": "Claude Desktop은 표준 모드를 가리키지만 이전 Univers Gateway 자격 증명 파일이 남아 있습니다: {paths}.",
  ...
  "integrations.detail.grokAbsent": "설정에 Univers Gateway 블록이 없습니다",
  "integrations.dialog.grok.title": "Grok Build 연동을 해제할까요?",
  "integrations.dialog.grok.changes": "{path}에서 Univers Gateway가 표시해 둔 블록만 제거합니다. 블록 바깥에 직접 쓴 내용은 그대로 둡니다.",
  "integrations.dialog.grok.breakage": "해제하면 Grok Build에서 Univers Gateway 모델 별칭이 사라집니다. xAI 계정으로 쓰던 모델은 그대로입니다.",
  "integrations.dialog.grok.undo": "Univers Gateway가 loopback 주소로 실행 중이면, 다시 켤 때 지금 쓸 수 있는 모델 목록으로 블록을 새로 씁니다.",
  "integrations.dialog.grok.confirm": "해제",
  "integrations.native.msg.nonLoopbackRemoved": "Grok Build은 Univers Gateway가 loopback 주소로 실행 중일 때만 자동 등록할 수 있습니다. loopback 주소를 가리키던 이전 블록은 제거했습니다.",
  "integrations.native.msg.nonLoopbackRemovedNoop": "Grok Build은 Univers Gateway가 loopback 주소로 실행 중일 때만 자동 등록할 수 있습니다. 제거할 이전 블록은 없었습니다.",
  "integrations.native.msg.nonLoopbackSuperseded": "Grok Build은 Univers Gateway가 loopback 주소로 실행 중일 때만 자동 등록할 수 있습니다. 그 사이 다른 곳에서 설정에 블록이 새로 쓰여, 지금 파일에 있는 블록은 이 요청이 만든 것이 아닙니다.",
  "integrations.native.error.orphanedMarker": "{path}에 Univers Gateway 시작 표시는 있는데 끝 표시가 없습니다. 어디까지가 우리 블록인지 확신할 수 없어 파일을 건드리지 않았습니다.",
  ...
  "integrations.onboarding": "적용하면 먼저 백업을 보관한 뒤 Univers Gateway 제공자 블록 하나만 씁니다. 해제는 그 블록만 제거하며 보관된 스냅샷으로 복원할 수 있습니다.",
  "integrations.empty.title": "설치된 클라이언트가 감지되지 않았습니다",
  "integrations.empty.body": "지원 클라이언트를 설치한 뒤 돌아와 Univers Gateway를 적용하세요.",
  ...
  "integrations.error.conflict": "Univers Gateway가 쓴 뒤 설정이 변경되었습니다. 아무 내용도 제거하지 않았습니다.",
  ...
  "integrations.bulk.body": "Univers Gateway가 소유한 블록만 제거합니다. 각 클라이언트의 변경 전 스냅샷을 보관합니다.",
  ...
  "codexAuth.autoSwitchQuotaDesc": "할당량은 새 작업/바인딩 없는 작업을 항상 만료 기한 기준으로 배정합니다. 사용량이 {threshold}% 이상이면 바인딩된 작업도 다음 요청에서 이동할 수 있습니다. Go/Free는 30일만 봅니다.",
  ...
  "accountPool.strategyHintQuota": "할당량 전략은 새 작업/바인딩 없는 작업을 만료 기한 기준으로 배정하며, 사용량 임계값은 기존 바인딩 작업의 이동만 제어합니다.",
  ...
  // api access page
  "api.title": "API 액세스",
  "api.subtitle": "생성한 API 키로 외부 앱에서 Univers Gateway 프록시에 접속합니다. 인증은 {authHeader} 헤더로 하며, 엔드포인트별로 받는 헤더는 아래 표에 있습니다.",
  ...
  "claude.authModeHint": "subscription은 Claude 계정 필요, proxy는 Univers Gateway 프록시만으로 사용 가능",
  ...
  "claude.smallFastModelNativeWarning": "비워 두면 Univers Gateway가 보조 모델 환경 변수를 설정하지 않습니다. Claude Code가 네이티브 Sonnet 모델을 사용할 수 있으며, 네이티브 프로바이더 요금이 발생할 수 있습니다.",
  ...
  "common.close": "닫기",
  "common.ok": "확인",
  "app.logoAria": "Univers Gateway 로고",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "cws.howTitle": "동작 방식",
  "cws.howBody": "Codex에서 콤보의 공개 모델 이름을 요청하세요. 설정하지 않으면 combo/<id>가 기본값입니다. Univers Gateway는 재시도 가능한 업스트림 오류에서만 다음 대상으로 넘깁니다. 사용 가능한 대상이 없으면 전역 기본 프로바이더로 우회하지 않고 요청을 실패 처리합니다.",
  ...
  "grok.subtitle": "Univers Gateway가 Grok 설정에 등록한 모델입니다.",
  "grok.loading": "Grok 상태를 불러오는 중…",
  "grok.loadFail": "Grok 설정을 읽지 못했습니다.",
  "grok.notConfiguredTitle": "Grok Build가 연결되지 않았습니다",
  "grok.notConfiguredHint": "Grok을 설치한 뒤 프록시를 다시 시작하면 Univers Gateway가 관리 블록을 다음 위치에 씁니다:",
  "grok.endpoint": "엔드포인트",
  "grok.colModel": "모델",
