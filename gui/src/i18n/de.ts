...
export const de: Record<TKey, string> = {
  ...
  "auth.adminTokenTitle": "Univers Gateway-Admin-Token (OPENCODEX_ADMIN_AUTH_TOKEN)",
  ...
  "startup.subtitle": "Prüft, ob Codex Univers Gateway nach einem Neustart erreicht, bevor lokales Proxy-Routing in einer Wiederverbindungsschleife endet.",
  ...
  "startup.summary.protected": "Univers Gateway ist nach einem Neustart verfügbar",
  ...
  "startup.riskDetailCustomLocal": "Codex verwendet ein benutzerdefiniertes lokales Gateway. Univers Gateway kann dessen Neustart-Lebenszyklus weder verwalten noch prüfen.",
  ...
  "startup.codexRuntime.clampHidden": "Einige Reasoning-Effort-Optionen wurden ausgeblendet, weil Univers Gateway Codex {version} verwendet hat.",
  "startup.codexRuntime.clampHiddenWithEfforts": "Einige Reasoning-Effort-Optionen wurden ausgeblendet, weil Univers Gateway Codex {version} verwendet hat (entfernt: {efforts}).",
  "startup.codexRuntime.olderBinary": "Univers Gateway verwendet eine ältere Codex-Binary ({version}). Eine neuere Installation ist verfügbar.",
  "dash.subtitle": "Live-Status des lokalen Univers Gateway-Proxys, seiner Anbieter und der in Codex gerouteten Modelle.",
  ...
  "dash.codexAutoStart": "Univers Gateway mit Codex starten",
  ...
  "dash.shadowCallTooltip": "Die Codex-App ruft im Hintergrund ein Hilfsmodell für Titelgenerierung, Commit-Nachrichten und Skill-Orchestrierung auf. Das Modell wechselt zwischen Client-Versionen, daher fängt Univers Gateway diesen Satz ab: {models}.",
  ...
  "dash.maintenanceHint": "Aktualisiere Codex’ Modellkatalog oder installiere eine neuere Univers Gateway-Version.",
  ...
  "dash.projectConfigTitle": "Projekt-Codex-Konfig umgeht Univers Gateway",
  "dash.projectConfigHint": "Diese repo-lokalen Einstellungen überschreiben den Univers Gateway-Proxy (z. B. direkt zu OpenCode Go routen). Entferne sie, damit die Routing aus ~/.codex/config.toml in diesem Projekt greift.",
  "dash.checkUpdate": "Update prüfen",
  "dash.updateTitle": "Univers Gateway aktualisieren",
  ...
  "dash.updateStatus.running": "Univers Gateway wird aktualisiert.",
  ...
  "prov.subtitle": "Konfiguriere die Upstream-Anbieter, die Univers Gateway in Codex routet. Melde dich mit einem Konto an, füge einen Anbieter hinzu oder bearbeite die Rohkonfiguration.",
  ...
  "oauthTos.anthropicBody": "Die direkte Wiederverwendung von Claude-Abo-OAuth-Tokens über einen Drittanbieter-Proxy wie Univers Gateway ist keine von Anthropic unterstützte Integration und kann zu Zugriffsbeschränkungen führen. Unterstützte Agent-SDK-Integrationen, die Claude-Abos verwenden, sind davon getrennt.",
  "oauthTos.highBody": "Univers Gateway verbindet {provider} über einen OAuth-Pfad eines Drittanbieters. Bei nicht unterstützter Nutzung kann der Zugriff eingeschränkt oder gesperrt werden.",
  "oauthTos.elevatedBody": "Univers Gateway verbindet {provider} über einen inoffiziellen OAuth-Pfad. Nutze nach Möglichkeit den offiziellen Client; ungewöhnlicher oder automatisierter Traffic kann als Missbrauch gewertet und der Zugriff eingeschränkt oder gesperrt werden.",
  "oauthTos.saferPath": "Sicherere Option: Hinterlege stattdessen einen API-Schlüssel in Univers Gateway.",
  ...
  "sub.subtitle": "Codex {cmd} bewirbt nur die ersten 5 Modelle (nach Priorität) als Overrides. Wähle hier bis zu 5 — natives gpt oder geroutet — und Univers Gateway setzt ihre Katalog-Priorität, sodass genau diese führen. Jedes andere Modell bleibt über seinen exakten Namen aufrufbar; dies steuert nur die Anzeige.",
  ...
  "logs.subtitle": "Letzte Anfragen über den lokalen Univers Gateway-Proxy, neueste zuerst.",
  ...
  "usage.range.1d": "Tag",
  "usage.range.30d": "Monat",
  "usage.range.7d": "Woche",
  "usage.window.older": "Vorheriger Zeitraum",
  "usage.window.newer": "Nächster Zeitraum",
  ...
  "usage.section.keys": "Zugangsschlüssel",
  ...
  "usage.filter.key.label": "Zugangsschlüssel",
  "usage.filter.key.all": "Alle Schlüssel",
  "usage.filter.key.clear": "Schlüsselfilter zurücksetzen",
  "usage.key.none": "Ohne Zugangsschlüssel",
  "usage.keys.rangeLimited": "Die Aufschlüsselung nach Schlüssel deckt Tages- und Wochenfenster ab. Monats- und Gesamtzeiträume werden ohne Schlüsseldimension aggregiert.",
  "usage.col.requests": "Anfragen",
  "usage.col.measured": "Gemessen",
  "usage.col.reported": "Gemeldet",
  "usage.col.tokens": "Tokens",
  "usage.col.key": "Schlüssel",
  "usage.col.cost": "Geschätzte Kosten",
  "usage.col.unpriced": "Ohne Preis",
  ...
  "integrations.subtitle": "Clients mit Univers Gateway verbinden, Zugangsdaten verwalten und Client-Konfigurationen wiederherstellen.",
  ...
  "integrations.codex.body": "Die Codex-Anbindung wird vom Proxy-Dienst verwaltet. Beim Start von Univers Gateway wird sie angewendet; beim Stoppen des Dienstes wird das native Routing wiederhergestellt.",
  ...
  "integrations.dialog.desktop.changes": "Falls {path} ein von Univers Gateway verwaltetes Gateway-Profil enthält, wählt Desktop zuerst ein neues Standardprofil ohne Zugangsdaten und entfernt danach das alte Profil und dessen Sicherung.",
  "integrations.dialog.desktop.breakage": "Claude Desktop verwendet dann statt über Univers Gateway gerouteter Modelle wieder das standardmäßige Claude.",
  "integrations.dialog.desktop.undo": "Beim erneuten Aktivieren wird das Univers Gateway-Profil aus deinen gespeicherten Modellzuweisungen neu erstellt.",
  ...
  "integrations.native.error.desktopCleanupIncomplete": "Claude Desktop zeigt auf den Standardmodus, aber alte Univers Gateway-Zugangsdaten befinden sich noch unter: {paths}.",
  ...
  "integrations.detail.grokAbsent": "Kein Univers Gateway-Block in der Konfiguration",
  "integrations.dialog.grok.title": "Grok-Build-Integration deaktivieren?",
  "integrations.dialog.grok.changes": "Aus {path} wird nur der von Univers Gateway markierte Block entfernt. Manuell geschriebener Inhalt außerhalb des Blocks bleibt unverändert.",
  "integrations.dialog.grok.breakage": "Nach dem Deaktivieren verschwinden die Univers Gateway-Modellaliase aus Grok Build. Modelle, die mit dem xAI-Konto verwendet wurden, bleiben erhalten.",
  "integrations.dialog.grok.undo": "Wenn Univers Gateway unter einer Loopback-Adresse läuft, wird beim erneuten Aktivieren ein neuer Block aus der aktuell verfügbaren Modellliste geschrieben.",
  "integrations.dialog.grok.confirm": "Deaktivieren",
  "integrations.native.msg.nonLoopbackRemoved": "Grok Build kann nur automatisch registriert werden, wenn Univers Gateway unter einer Loopback-Adresse läuft. Der vorherige Block mit Verweis auf Loopback wurde entfernt.",
  "integrations.native.msg.nonLoopbackRemovedNoop": "Grok Build kann nur automatisch registriert werden, wenn Univers Gateway unter einer Loopback-Adresse läuft. Es gab keinen vorherigen Block zu entfernen.",
  "integrations.native.msg.nonLoopbackSuperseded": "Grok Build kann nur automatisch registriert werden, wenn Univers Gateway unter einer Loopback-Adresse läuft. Inzwischen hat eine andere Stelle einen neuen Block in die Konfiguration geschrieben; der aktuelle Block in der Datei wurde daher nicht von dieser Anfrage erstellt.",
  "integrations.native.error.orphanedMarker": "{path} enthält eine Univers Gateway-Startmarkierung, aber keine Endmarkierung. Die Datei wurde nicht geändert, weil das Ende des Blocks nicht sicher bestimmt werden kann.",
  ...
  "integrations.onboarding": "Beim Anwenden wird nach dem Speichern einer Sicherung genau ein Univers Gateway-Anbieterblock geschrieben. Beim Deaktivieren wird nur dieser Block entfernt; eine aufbewahrte Momentaufnahme kann wiederhergestellt werden.",
  "integrations.empty.title": "Keine installierten Clients erkannt",
  "integrations.empty.body": "Installiere einen unterstützten Client und kehre dann hierher zurück, um Univers Gateway anzuwenden.",
  ...
  "integrations.error.conflict": "Die Konfiguration wurde geändert, nachdem Univers Gateway sie geschrieben hatte. Es wurde nichts entfernt.",
  ...
  "integrations.bulk.body": "Nur der Univers Gateway-eigene Block wird entfernt. Für jeden Client wird vorher eine Momentaufnahme gespeichert.",
  ...
  "api.subtitle": "Mit generierten API-Schlüsseln greifen externe Apps auf den Univers Gateway-Proxy zu. Die Authentifizierung läuft über den {authHeader}-Header; welche Header ein Endpunkt akzeptiert, steht in der Tabelle unten.",
  ...
  "claude.smallFastModelNativeWarning": "Wenn kein Modell gewählt ist, setzt Univers Gateway keine Hilfsmodell-Overrides. Claude Code kann dann sein natives Sonnet-Modell verwenden, wodurch Kosten bei deinem nativen Anbieter entstehen können.",
  ...
  "common.ok": "OK",
  "app.logoAria": "Univers Gateway-Logo",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "cws.howBody": "Fordern Sie in Codex den öffentlichen Modellnamen der Combo an. Ohne eigenen Namen gilt combo/<id>. Univers Gateway wählt ein Ziel und springt nur bei wiederholbaren Upstream-Fehlern. Ist kein Ziel verfügbar, schlägt die Anfrage geschlossen fehl, statt den globalen Standardanbieter zu verwenden.",
  ...
  "grok.subtitle": "Modelle, die Univers Gateway in deiner Grok-Konfiguration registriert hat.",
  ...
  "grok.notConfiguredHint": "Starte den Proxy mit installiertem Grok neu; Univers Gateway schreibt dann einen verwalteten Block nach:",
