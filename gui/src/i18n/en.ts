...
export const en = {
  ...
  "startup.subtitle": "Verify that Codex can reach Univers Gateway after a restart, before local proxy routing becomes a reconnect loop.",
  ...
  "startup.summary.protected": "Univers Gateway will be available after restart",
  ...
  "startup.riskDetailCustomLocal": "Codex points to a custom local gateway. Univers Gateway cannot manage or verify that gateway's restart lifecycle.",
  ...
  "startup.codexRuntime.clampHidden": "Some reasoning effort options were hidden because Univers Gateway used Codex {version}.",
  "startup.codexRuntime.clampHiddenWithEfforts": "Some reasoning effort options were hidden because Univers Gateway used Codex {version} (removed: {efforts}).",
  "startup.codexRuntime.olderBinary": "Univers Gateway is using an older Codex binary ({version}). A newer installation is available.",

  // dashboard
  "dash.subtitle": "Live status of the local Univers Gateway proxy, its providers, and the models routed into Codex.",
  ...
  "dash.codexAutoStart": "Start Univers Gateway with Codex",
  ...
  "dash.shadowCallTooltip": "Codex App makes background helper calls for thread title generation, commit message generation, and skill orchestration. The helper model changed across client versions, so Univers Gateway intercepts every model in this set: {models}. Enable this to redirect those calls to your chosen model.",
  ...
  "dash.maintenanceHint": "Refresh Codex's model catalog or install a newer Univers Gateway release.",
  ...
  "dash.projectConfigTitle": "Project Codex config bypasses Univers Gateway",
  "dash.projectConfigHint": "These repo-local settings override the Univers Gateway proxy (e.g. route to OpenCode Go directly). Remove them so ~/.codex/config.toml routing applies in that project.",
  "dash.checkUpdate": "Check update",
  "dash.updateTitle": "Update Univers Gateway",
  ...
  "dash.updateStatus.running": "Updating Univers Gateway.",
  ...
  // providers
  "prov.subtitle": "Configure the upstream providers Univers Gateway routes into Codex. Log in with an account, add a provider, or edit the raw config.",
  ...
  "oauthTos.anthropicBody": "Directly reusing Claude subscription OAuth tokens through a third-party proxy such as Univers Gateway is not a supported Anthropic integration and may lead to access restrictions. Supported Agent SDK integrations that use Claude subscriptions are separate.",
  "oauthTos.highBody": "Univers Gateway connects {provider} through a third-party OAuth path. Unsupported use may lead to access limits or suspension.",
  "oauthTos.elevatedBody": "Univers Gateway connects {provider} through an unofficial OAuth path. Use the official client when possible; unusual or automated traffic may be treated as abuse and access may be limited or suspended.",
  "oauthTos.saferPath": "Safer option: configure an API key in Univers Gateway instead.",
  ...
  "models.subtitle": "Toggle which models Codex sees — native GPT passthrough and routed providers, grouped by provider (click a header to collapse). Hidden models stay off the catalog + model picker but remain directly callable by exact id. Changes apply on the next Codex turn — Univers Gateway invalidates Codex's 5-min model cache so no restart is needed.",
  ...
  // subagents
  "sub.subtitle": "Codex's {cmd} advertises only the first 5 models (by priority) as overrides. Pick up to 5 here — native gpt or routed — and Univers Gateway sets their catalog priority so exactly these lead. Any other model is still callable by its exact name; this only controls what's shown.",
  ...
  "logs.tabLogs": "Logs",
  "logs.tabDebug": "Debug",
  "logs.subtitle": "Recent requests routed through the local Univers Gateway proxy, newest first.",
  ...
  "usage.range.1d": "Day",
  "usage.range.30d": "Month",
  "usage.range.7d": "Week",
  "usage.window.older": "Previous period",
  "usage.window.newer": "Next period",
  ...
  "usage.section.keys": "Admission keys",
  ...
  "usage.filter.key.label": "Admission key",
  "usage.filter.key.all": "All keys",
  "usage.filter.key.clear": "Clear key filter",
  "usage.key.none": "No admission key",
  "usage.keys.rangeLimited": "The per-key breakdown covers the day and week windows. Month and all-time ranges are aggregated without the key dimension.",
  "usage.col.requests": "Requests",
  "usage.col.measured": "Measured",
  "usage.col.reported": "Reported",
  "usage.col.tokens": "Tokens",
  "usage.col.key": "Key",
  "usage.col.cost": "Estimated cost",
  "usage.col.unpriced": "Unpriced",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "integrations.subtitle": "Connect clients to Univers Gateway, manage credentials, and restore client configuration.",
  ...
  "integrations.codex.body": "Codex wiring is owned by the proxy service. Starting Univers Gateway applies it; stopping the service restores native routing.",
  ...
  "integrations.detail.grokAbsent": "No Univers Gateway block in the config",
  "integrations.dialog.grok.title": "Disable the Grok Build integration?",
  "integrations.dialog.grok.changes": "Only the block marked by Univers Gateway will be removed from {path}. Content written outside the block will remain unchanged.",
  "integrations.dialog.grok.breakage": "Disabling removes the Univers Gateway model aliases from Grok Build. Models used with your xAI account remain available.",
  "integrations.dialog.grok.undo": "If Univers Gateway is running on a loopback address, turning this back on writes a new block from the models currently available.",
  "integrations.dialog.grok.confirm": "Disable",
  "integrations.dialog.desktop.title": "Disable Claude Desktop integration?",
  "integrations.dialog.desktop.changes": "If {path} contains a Univers Gateway-managed profile, Desktop will first select a new credential-free standard profile, then remove the old profile and backup.",
  "integrations.dialog.desktop.breakage": "Claude Desktop will return to standard Claude instead of models routed through Univers Gateway.",
  "integrations.dialog.desktop.undo": "Turning this back on regenerates the Univers Gateway profile from your saved model assignments.",
  ...
  "integrations.native.msg.nonLoopbackRemoved": "Grok Build can be registered automatically only while Univers Gateway runs on a loopback address. The previous block that pointed to loopback was removed.",
  "integrations.native.msg.nonLoopbackRemovedNoop": "Grok Build can be registered automatically only while Univers Gateway runs on a loopback address. There was no previous block to remove.",
  "integrations.native.msg.nonLoopbackSuperseded": "Grok Build can be registered automatically only while Univers Gateway runs on a loopback address. Another process wrote a new block in the meantime, so the block now in the file was not created by this request.",
  "integrations.native.error.orphanedMarker": "{path} has an Univers Gateway start marker but no end marker. The file was left unchanged because Univers Gateway cannot determine where its block ends.",
  ...
  "integrations.native.error.desktopCleanupIncomplete": "Claude Desktop is pointed at standard mode, but old Univers Gateway credential files remain at: {paths}.",
  ...
  "integrations.onboarding": "Applying writes one Univers Gateway provider block after saving a backup. Disable removes only that block, and a retained snapshot can be restored.",
  "integrations.empty.title": "No installed clients were detected",
  "integrations.empty.body": "Install a supported client, then return here to apply Univers Gateway.",
  ...
  "integrations.error.conflict": "The config changed after Univers Gateway wrote it. Nothing was removed.",
  ...
  "integrations.bulk.body": "Only the Univers Gateway-owned block is removed. A pre-write snapshot is kept for each client.",
  ...
  "codexAuth.autoSwitchQuotaDesc": "Quota always deadline-schedules new/unbound tasks. At {threshold}% usage or above, an already-bound task may also move on its next request; Go/Free use 30d only.",
  ...
  "accountPool.strategyHintQuota": "Quota deadline-schedules every new/unbound task; the usage threshold only controls migration of an existing bound task.",
  ...
  "api.subtitle": "Use generated API keys to access the Univers Gateway proxy from external apps. Keys authenticate via the {authHeader} header; see the table below for what each endpoint accepts.",
  ...
  "claude.smallFastModelNativeWarning": "When unset, Univers Gateway leaves the helper-model overrides unset. Claude Code may use its native Sonnet model, which may incur charges from your native provider.",
  ...
  "cws.howBody": "Ask Codex for the combo's public model name. Without one, the default is combo/<id>. Univers Gateway selects a target and hops only on retryable upstream failures. If no target remains available, the request fails closed instead of using the global default provider.",
  ...
  "grok.subtitle": "Models Univers Gateway has registered in your Grok config.",
  ...
  "grok.notConfiguredHint": "Start or restart the proxy with Grok installed and Univers Gateway writes a managed block into:",
